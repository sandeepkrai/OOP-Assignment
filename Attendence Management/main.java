            ...
            while (op != 9) {
                ...
                switch (op) {
                        ...
                        try {
                            ...
                            if (stream.equals("Medical")) {
                                ...
                                while (r3.next()) {
                                    System.out.println("------------------------------------------------");
                                    System.out.println(
                                            "Name of Student: " + r3.getString("Name") + "\nId: " + r3.getInt("Id"));
                                    ...
                                    if (Grade == 'F') {
                                        System.out.println("We are Very Sorry " + r3.getString("Name")
                                                + ". You are Failed this time");
                                    } else {
                                        System.out.println("Congratulations " + r3.getString("Name")
                                                + " You are Passes in Examinations");
                                    }
                                }
                    ...
                    case 4:
                        ...
                        String Sub = sc.next();
                        PreparedStatement sm = con
                                .prepareStatement("UPDATE studentresult set " + Sub + "=? where Id=" + sid);
